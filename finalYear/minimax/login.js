...
function login(){
  ...
  .then((userCredential) => {
    ...
    db.ref().child('game/' + userEmail + '/game1').set('?')
    db.ref().child('game/' + userEmail + '/game1').on('value', snap => questionMark.innerText = snap.val());
    db.ref().child('game/' + userEmail + '/game2').set('?');
    db.ref().child('game/' + userEmail + '/game2').on('value', snap => questionMark.innerText = snap.val());
    db.ref().child('game/' + userEmail + '/game3').set('?');
    db.ref().child('game/' + userEmail + '/game3').on('value', snap => questionMark.innerText = snap.val());
